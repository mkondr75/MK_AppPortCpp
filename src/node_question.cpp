...
static LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
	...
	case WM_CREATE: {
		...
		g_radio_custom = CreateWindowW(L"BUTTON", L"Использовать пользовательскую Node.js", WS_VISIBLE | WS_CHILD | BS_AUTORADIOBUTTON, 20, 100, 300, 20, hwnd, (HMENU)IDC_RADIO_CUSTOM, NULL, NULL);
		// ApplyFont(g_radio_custom);
		SendMessageW(g_radio_custom, WM_SETFONT, (WPARAM)g_font, TRUE);
		// g_edit_path = CreateWindowW(L"EDIT", g_model->custom_node_path.c_str(), WS_VISIBLE | WS_CHILD | WS_BORDER | ES_AUTOHSCROLL, 40, 130, 500, 24, hwnd, (HMENU)IDC_EDIT_PATH, NULL, NULL);
		// ApplyFont(g_edit_path);
		// SendMessageW(g_edit_path, WM_SETFONT, (WPARAM)g_font, TRUE);
		// CreateWindowW(L"BUTTON", L"...", WS_VISIBLE | WS_CHILD, 550, 130, 40, 24, hwnd, (HMENU)IDC_BUTTON_BROWSE, NULL, NULL);

		CreateWindowW(L"BUTTON", L"OK", WS_VISIBLE | WS_CHILD, 260, 190, 100, 30, hwnd, (HMENU)IDC_BUTTON_OK, NULL, NULL);
